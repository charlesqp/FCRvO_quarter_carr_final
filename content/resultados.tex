...
\subsection{Controlador Robusto por realimentação de estados com \( \mathcal{D}\)-estabilidade garantida}\label{subsec:res:control}
...
Uma simulação temporal do sistema linear em malha aberta é exibido nas figuras a seguir. A figura \ref{fig:setup_testeobs} mostra o experimento desenvolvido em Simulink para testar os observadores.
